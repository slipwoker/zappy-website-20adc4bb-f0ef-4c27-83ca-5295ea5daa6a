document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .catch(function(error) {
                    ...
                    errorMessage.style.cssText = 'background: #f8d7da; color: #721c24; padding: 1rem; border-radius: 4px; margin-top: 1rem;';
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.hasAttribute('data-validate-on-input')) {
                validateField(input);
            }
        });
    ...
    if (animatedElements.length > 0) {
        function isElementInViewport(el, offset) {
            ...
            return (
                rect.top <= windowHeight - (offset || 100) &&
                rect.bottom >= 0
            );
        }
            ...
            animatedElements.forEach(function(el) {
                if (isElementInViewport(el, 80)) {
                    ...
                    if (el.hasAttribute('data-animate-delay')) {
                        el.style.transitionDelay = el.getAttribute('data-animate-delay');
                    }
        ...
        style.textContent = `
            .fade-in, .fade-in-up, .fade-in-left, .fade-in-right, [data-animate] {
                opacity: 0;
            ...
            [dir="rtl"] .fade-in-right.animated {
                transform: translateX(0);
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '20adc4bb-f0ef-4c27-83ca-5295ea5daa6a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '20adc4bb-f0ef-4c27-83ca-5295ea5daa6a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '20adc4bb-f0ef-4c27-83ca-5295ea5daa6a';
